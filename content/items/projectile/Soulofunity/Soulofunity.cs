...
namespace testingyharim.content.items.projectile.Soulofunity { 
    public class Soulofunity : ModProjectile
{
    ...
    public override void AI()
    {
        ...
        {
            player.ClearBuff(ModContent.BuffType<SoulofunityBuff>());
        }
        if (player.HasBuff(ModContent.BuffType<SoulofunityBuff>()))
        {
