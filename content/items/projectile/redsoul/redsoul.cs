...
namespace testingyharim.content.items.projectile.redsoul
{
    ...
    public class RedsoulBuff : ModBuff
    {
        ...
        {
            if (player.ownedProjectileCounts[ModContent.ProjectileType<RedsoulMinionItem.Redsoul>()] > 0)
            {
    ...
    public class RedsoulMinionItem : ModItem
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void SetDefaults()
        {
            ...
            Item.buffType = ModContent.BuffType<RedsoulBuff>();
            // No buffTime because otherwise the item tooltip would say something like "1 minute duration"
            Item.shoot = ModContent.ProjectileType<Redsoul>();
        }
        ...
        public class Redsoul : ModProjectile
        {
            ...
            public override void AI()
            {
                ...
                {
                    player.ClearBuff(ModContent.BuffType<RedsoulBuff>());
                }
                if (player.HasBuff(ModContent.BuffType<RedsoulBuff>()))
                {
