...
namespace testingyharim.content.items.projectile.greensoul
{
    ...
    public class GreensoulBuff : ModBuff
    {
        ...
        {
            if (player.ownedProjectileCounts[ModContent.ProjectileType<GreensoulItem.Greensoul>()] > 0)
            {
    ...
    public class GreensoulItem : ModItem
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void SetDefaults()
        {
            ...
            Item.buffType = ModContent.BuffType<GreensoulBuff>();
            // No buffTime because otherwise the item tooltip would say something like "1 minute duration"
            Item.shoot = ModContent.ProjectileType<Greensoul>();
        }
        ...
        public class Greensoul : ModProjectile
        {
            ...
            public override void AI()
            {
                ...
                {
                    player.ClearBuff(ModContent.BuffType<GreensoulBuff>());
                }
                if (player.HasBuff(ModContent.BuffType<GreensoulBuff>()))
                {
